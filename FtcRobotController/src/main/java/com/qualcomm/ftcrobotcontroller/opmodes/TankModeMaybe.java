...
public class TankModeMaybe extends OpMode {
    ...
    public void loop() {
        ...
        double right2 = rY * rY;
        boolean rackPower1 = gamepad1.x;
        boolean rackPower2 = gamepad1.a;
        boolean winchPower1 = gamepad1.y;
        boolean winchPower2 = gamepad1.b;
